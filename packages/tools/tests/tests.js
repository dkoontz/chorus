...
var $author$project$Tools$File$countOccurrences$ = function(needle, haystack) {
	if ($gren_lang$core$String$isEmpty(needle)) {
		return 0;
	} else {
		var parts = A2($gren_lang$core$String$split, needle, haystack);
		return $gren_lang$core$Array$length(parts) - 1;
	}
};
var $author$project$Tools$File$countOccurrences = F2($author$project$Tools$File$countOccurrences$);
...
var $author$project$FileHelperTests$countOccurrencesTests = $gren_lang$test$Test$describe$('countOccurrences', [ $gren_lang$test$Test$test$('counts single occurrence', function(_v0) {
			return A2($gren_lang$test$Expect$equal, 1, $author$project$Tools$File$countOccurrences$('foo', 'hello foo world'));
		}), $gren_lang$test$Test$test$('counts multiple occurrences', function(_v1) {
			return A2($gren_lang$test$Expect$equal, 3, $author$project$Tools$File$countOccurrences$('a', 'banana'));
		}), $gren_lang$test$Test$test$('returns 0 for empty needle', function(_v2) {
			return A2($gren_lang$test$Expect$equal, 0, $author$project$Tools$File$countOccurrences$('', 'hello world'));
		}), $gren_lang$test$Test$test$('returns 0 when needle not found', function(_v3) {
			return A2($gren_lang$test$Expect$equal, 0, $author$project$Tools$File$countOccurrences$('xyz', 'hello world'));
		}), $gren_lang$test$Test$test$('returns 0 for empty haystack', function(_v4) {
			return A2($gren_lang$test$Expect$equal, 0, $author$project$Tools$File$countOccurrences$('foo', ''));
		}), $gren_lang$test$Test$test$('handles overlapping patterns correctly', function(_v5) {
			return A2($gren_lang$test$Expect$equal, 1, $author$project$Tools$File$countOccurrences$('aa', 'aaa'));
		}), $gren_lang$test$Test$test$('handles needle longer than haystack', function(_v6) {
			return A2($gren_lang$test$Expect$equal, 0, $author$project$Tools$File$countOccurrences$('hello world', 'hi'));
		}), $gren_lang$test$Test$test$('is case sensitive', function(_v7) {
			return A2($gren_lang$test$Expect$equal, 1, $author$project$Tools$File$countOccurrences$('FOO', 'foo FOO Foo'));
		}), $gren_lang$test$Test$test$('handles multiline content', function(_v8) {
			return A2($gren_lang$test$Expect$equal, 3, $author$project$Tools$File$countOccurrences$('line', 'first line\nsecond line\nthird line'));
		}), $gren_lang$test$Test$test$('handles special characters', function(_v9) {
			return A2($gren_lang$test$Expect$equal, 2, $author$project$Tools$File$countOccurrences$('[test]', 'value = [test] + [test]'));
		}) ]);
var $author$project$Tools$File$parseSearchLine = function(line) {
	var parts = A2($gren_lang$core$String$split, ':', line);
	var _v0 = { first: $gren_lang$core$Array$first(parts), second: A2($gren_lang$core$Array$get, 1, parts) };
	if ((_v0.first.$ === 'Just') && (_v0.second.$ === 'Just')) {
		var path = _v0.first.a;
		var lineStr = _v0.second.a;
		var _v1 = $gren_lang$core$String$toInt(lineStr);
		if (_v1.$ === 'Nothing') {
			return $gren_lang$core$Maybe$Nothing;
		} else {
			var lineNum = _v1.a;
			var content = A2($gren_lang$core$String$join, ':', $gren_lang$core$Array$dropFirst$(2, parts));
			return $gren_lang$core$Maybe$Just({ content: content, line: lineNum, path: path });
		}
	} else {
		return $gren_lang$core$Maybe$Nothing;
	}
};
var $author$project$FileHelperTests$parseSearchLineTests = $gren_lang$test$Test$describe$('parseSearchLine', [ $gren_lang$test$Test$test$('parses standard ripgrep format', function(_v0) {
			return A2($gren_lang$test$Expect$equal, $gren_lang$core$Maybe$Just({ content: 'matching content here', line: 42, path: '/path/to/file.txt' }), $author$project$Tools$File$parseSearchLine('/path/to/file.txt:42:matching content here'));
		}), $gren_lang$test$Test$test$('handles colons in content', function(_v1) {
			return A2($gren_lang$test$Expect$equal, $gren_lang$core$Maybe$Just({ content: 'key: value: nested', line: 10, path: '/path/file.txt' }), $author$project$Tools$File$parseSearchLine('/path/file.txt:10:key: value: nested'));
		}), $gren_lang$test$Test$test$('handles empty content', function(_v2) {
			return A2($gren_lang$test$Expect$equal, $gren_lang$core$Maybe$Just({ content: '', line: 5, path: '/path/file.txt' }), $author$project$Tools$File$parseSearchLine('/path/file.txt:5:'));
		}), $gren_lang$test$Test$test$('returns Nothing for missing line number', function(_v3) {
			return A2($gren_lang$test$Expect$equal, $gren_lang$core$Maybe$Nothing, $author$project$Tools$File$parseSearchLine('/path/file.txt'));
		}), $gren_lang$test$Test$test$('returns Nothing for non-numeric line number', function(_v4) {
			return A2($gren_lang$test$Expect$equal, $gren_lang$core$Maybe$Nothing, $author$project$Tools$File$parseSearchLine('/path/file.txt:abc:content'));
		}), $gren_lang$test$Test$test$('returns Nothing for empty string', function(_v5) {
			return A2($gren_lang$test$Expect$equal, $gren_lang$core$Maybe$Nothing, $author$project$Tools$File$parseSearchLine(''));
		}), $gren_lang$test$Test$test$('handles relative paths', function(_v6) {
			return A2($gren_lang$test$Expect$equal, $gren_lang$core$Maybe$Just({ content: 'import Module', line: 100, path: 'src/main.gren' }), $author$project$Tools$File$parseSearchLine('src/main.gren:100:import Module'));
		}), $gren_lang$test$Test$test$('Windows-style paths parse incorrectly (expected)', function(_v7) {
			return A2($gren_lang$test$Expect$equal, $gren_lang$core$Maybe$Nothing, $author$project$Tools$File$parseSearchLine('C:/Users/test/file.txt:10:content'));
		}), $gren_lang$test$Test$test$('handles line number at boundary', function(_v8) {
			return A2($gren_lang$test$Expect$equal, $gren_lang$core$Maybe$Just({ content: 'first line', line: 1, path: '/file.txt' }), $author$project$Tools$File$parseSearchLine('/file.txt:1:first line'));
		}) ]);
var $author$project$FileHelperTests$suite = $gren_lang$test$Test$describe$('File Helper Functions', [ $author$project$FileHelperTests$countOccurrencesTests, $author$project$FileHelperTests$parseSearchLineTests ]);
var $author$project$Tools$Validation$WorkspaceRoot = function (a) {
	return { $: 'WorkspaceRoot', a: a };
};
var $gren_lang$node$FileSystem$Path$fromPosixString = _FilePath_fromPosix;
var $author$project$Tools$Validation$makeWorkspaceRoot = function(pathStr) {
	return $author$project$Tools$Validation$WorkspaceRoot($gren_lang$node$FileSystem$Path$fromPosixString(pathStr));
};
var $author$project$Tools$Validation$AbsolutePathNotAllowed = function (a) {
	return { $: 'AbsolutePathNotAllowed', a: a };
};
var $author$project$Tools$Validation$EmptyPath = { $: 'EmptyPath' };
var $author$project$Tools$Validation$PathTraversalAttempt = function (a) {
	return { $: 'PathTraversalAttempt', a: a };
};
var $author$project$Tools$Validation$ValidPath = function (a) {
	return { $: 'ValidPath', a: a };
};
...
var $author$project$Tools$Validation$containsTraversal = function(pathStr) {
	var segments = A2($gren_lang$core$String$split, '/', pathStr);
	return $gren_lang$core$Array$any$(function(s) {
			return s === '..';
		}, segments);
};
var $gren_lang$core$String$startsWith = _String_startsWith;
var $author$project$Tools$Validation$validatePath$ = function(_v0, pathStr) {
	var workspaceRoot = _v0.a;
	var trimmed = $gren_lang$core$String$trim(pathStr);
	if ($gren_lang$core$String$isEmpty(trimmed)) {
		return $gren_lang$core$Result$Err($author$project$Tools$Validation$EmptyPath);
	} else {
		if (A2($gren_lang$core$String$startsWith, '/', trimmed)) {
			return $gren_lang$core$Result$Err($author$project$Tools$Validation$AbsolutePathNotAllowed({ path: trimmed }));
		} else {
			if ($author$project$Tools$Validation$containsTraversal(trimmed)) {
				return $gren_lang$core$Result$Err($author$project$Tools$Validation$PathTraversalAttempt({ path: trimmed, reason: 'Path contains \'..\' which could escape the workspace' }));
			} else {
				var relativePath = $gren_lang$node$FileSystem$Path$fromPosixString(trimmed);
				var fullPath = $gren_lang$node$FileSystem$Path$append$(relativePath, workspaceRoot);
				return $gren_lang$core$Result$Ok($author$project$Tools$Validation$ValidPath(fullPath));
			}
		}
	}
};
var $author$project$Tools$Validation$validatePath = F2($author$project$Tools$Validation$validatePath$);
var $author$project$ValidationTests$absolutePathTests = $gren_lang$test$Test$describe$('Absolute path prevention', [ $gren_lang$test$Test$test$('rejects absolute path starting with /', function(_v0) {
			var workspace = $author$project$Tools$Validation$makeWorkspaceRoot('/var/chorus/workspaces');
			var result = $author$project$Tools$Validation$validatePath$(workspace, '/etc/passwd');
			if ((result.$ === 'Err') && (result.a.$ === 'AbsolutePathNotAllowed')) {
				return $gren_lang$test$Expect$pass;
			} else {
				return $gren_lang$test$Expect$fail('Expected AbsolutePathNotAllowed error');
			}
		}), $gren_lang$test$Test$test$('rejects absolute path to workspace', function(_v2) {
			var workspace = $author$project$Tools$Validation$makeWorkspaceRoot('/var/chorus/workspaces');
			var result = $author$project$Tools$Validation$validatePath$(workspace, '/var/chorus/workspaces/file.txt');
			if ((result.$ === 'Err') && (result.a.$ === 'AbsolutePathNotAllowed')) {
				return $gren_lang$test$Expect$pass;
			} else {
				return $gren_lang$test$Expect$fail('Expected AbsolutePathNotAllowed error');
...
var $author$project$ValidationTests$emptyPathTests = $gren_lang$test$Test$describe$('Empty path handling', [ $gren_lang$test$Test$test$('rejects empty string', function(_v0) {
			var workspace = $author$project$Tools$Validation$makeWorkspaceRoot('/var/chorus/workspaces');
			var result = $author$project$Tools$Validation$validatePath$(workspace, '');
			if ((result.$ === 'Err') && (result.a.$ === 'EmptyPath')) {
				var _v2 = result.a;
				return $gren_lang$test$Expect$pass;
			} else {
				return $gren_lang$test$Expect$fail('Expected EmptyPath error');
			}
		}), $gren_lang$test$Test$test$('rejects whitespace-only string', function(_v3) {
			var workspace = $author$project$Tools$Validation$makeWorkspaceRoot('/var/chorus/workspaces');
			var result = $author$project$Tools$Validation$validatePath$(workspace, '   ');
			if ((result.$ === 'Err') && (result.a.$ === 'EmptyPath')) {
				var _v5 = result.a;
...
var $author$project$ValidationTests$pathTraversalTests = $gren_lang$test$Test$describe$('Path traversal prevention', [ $gren_lang$test$Test$test$('rejects simple path traversal', function(_v0) {
			var workspace = $author$project$Tools$Validation$makeWorkspaceRoot('/var/chorus/workspaces');
			var result = $author$project$Tools$Validation$validatePath$(workspace, '../etc/passwd');
			if ((result.$ === 'Err') && (result.a.$ === 'PathTraversalAttempt')) {
				return $gren_lang$test$Expect$pass;
			} else {
				return $gren_lang$test$Expect$fail('Expected PathTraversalAttempt error');
			}
		}), $gren_lang$test$Test$test$('rejects path traversal in middle', function(_v2) {
			var workspace = $author$project$Tools$Validation$makeWorkspaceRoot('/var/chorus/workspaces');
			var result = $author$project$Tools$Validation$validatePath$(workspace, 'foo/../../../etc/passwd');
			if ((result.$ === 'Err') && (result.a.$ === 'PathTraversalAttempt')) {
				return $gren_lang$test$Expect$pass;
			} else {
				return $gren_lang$test$Expect$fail('Expected PathTraversalAttempt error');
			}
		}), $gren_lang$test$Test$test$('rejects multiple path traversals', function(_v4) {
			var workspace = $author$project$Tools$Validation$makeWorkspaceRoot('/var/chorus/workspaces');
			var result = $author$project$Tools$Validation$validatePath$(workspace, '../../../../../../etc/passwd');
			if ((result.$ === 'Err') && (result.a.$ === 'PathTraversalAttempt')) {
				return $gren_lang$test$Expect$pass;
...
var $author$project$Tools$Validation$toString = function(_v0) {
	var path = _v0.a;
	return $gren_lang$node$FileSystem$Path$toPosixString(path);
};
var $author$project$ValidationTests$validPathTests = $gren_lang$test$Test$describe$('Valid paths', [ $gren_lang$test$Test$test$('accepts simple filename', function(_v0) {
			var workspace = $author$project$Tools$Validation$makeWorkspaceRoot('/var/chorus/workspaces');
			var result = $author$project$Tools$Validation$validatePath$(workspace, 'file.txt');
			if (result.$ === 'Ok') {
				var validPath = result.a;
				return A2($gren_lang$test$Expect$equal, $author$project$Tools$Validation$toString(validPath), '/var/chorus/workspaces/file.txt');
			} else {
				var err = result.a;
				return $gren_lang$test$Expect$fail('Expected Ok but got error');
			}
		}), $gren_lang$test$Test$test$('accepts nested path', function(_v2) {
			var workspace = $author$project$Tools$Validation$makeWorkspaceRoot('/var/chorus/workspaces');
			var result = $author$project$Tools$Validation$validatePath$(workspace, 'src/main/file.txt');
			if (result.$ === 'Ok') {
				var validPath = result.a;
				return A2($gren_lang$test$Expect$equal, $author$project$Tools$Validation$toString(validPath), '/var/chorus/workspaces/src/main/file.txt');
			} else {
				var err = result.a;
				return $gren_lang$test$Expect$fail('Expected Ok but got error');
			}
		}), $gren_lang$test$Test$test$('accepts current directory reference', function(_v4) {
			var workspace = $author$project$Tools$Validation$makeWorkspaceRoot('/var/chorus/workspaces');
			var result = $author$project$Tools$Validation$validatePath$(workspace, './file.txt');
			if (result.$ === 'Ok') {
				return $gren_lang$test$Expect$pass;
...
var $author$project$ValidationTests$suite = $gren_lang$test$Test$describe$('Path Validation', [ $author$project$ValidationTests$pathTraversalTests, $author$project$ValidationTests$absolutePathTests, $author$project$ValidationTests$emptyPathTests, $author$project$ValidationTests$validPathTests ]);
var $author$project$Main$main = $gren_lang$test_runner_node$Test$Runner$Node$run($gren_lang$test$Test$describe$('File Tools Tests', [ $author$project$ValidationTests$suite, $author$project$FileHelperTests$suite ]));
